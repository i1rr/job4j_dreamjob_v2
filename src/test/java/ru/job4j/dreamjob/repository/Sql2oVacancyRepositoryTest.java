...
class Sql2oVacancyRepositoryTest {
    ...
    void whenSaveThenGetSame() {
        ...
        var vacancy = sql2oVacancyRepository.save(new Vacancy("title", "description", creationDate, true, 1, file.getId()));
    ...
    void whenSaveSeveralThenGetAll() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var vacancy1 = sql2oVacancyRepository.save(new Vacancy("title1", "description1", creationDate, true, 1, file.getId()));
        var vacancy2 = sql2oVacancyRepository.save(new Vacancy("title2", "description2", creationDate, false, 1, file.getId()));
        var vacancy3 = sql2oVacancyRepository.save(new Vacancy("title3", "description3", creationDate, true, 1, file.getId()));
    ...
    void whenUpdateUnExistingVacancyThenGetFalse() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var vacancy = new Vacancy("title", "description", creationDate, true, 1, file.getId());
