...
class Sql2oCandidateRepositoryTest {
    ...
    void whenSaveThenGetSame() {
        ...
        var candidate = sql2oCandidateRepository.save(new Candidate("name", "description", creationDate, 1, file.getId()));
    ...
    void whenSaveSeveralThenGetAll() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var candidate1 = sql2oCandidateRepository.save(new Candidate("name1", "description1", creationDate, 1, file.getId()));
        var candidate2 = sql2oCandidateRepository.save(new Candidate("name2", "description2", creationDate, 1, file.getId()));
        var candidate3 = sql2oCandidateRepository.save(new Candidate("name3", "description3", creationDate, 1, file.getId()));
    ...
    void whenUpdateUnExistingCandidateThenGetFalse() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var candidate = new Candidate("name", "description", creationDate, 1, file.getId());
